({
    doInit : function(component, event, helper) {
        ...
        //Fetch the list from the Apex controller 
    ...
    CancelPopup: function(component, event, helper){
        ...
        var updateLookUpEvent = $A.get("e.c:LRC_CL_updateLookupName");
    ...
    selectedsObject: function(component, event, helper){
        ...
        //component.find('lookup').set("v.searchString", selectedRecName);
